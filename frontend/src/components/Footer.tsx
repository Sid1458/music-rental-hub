...
const footerLinks = {
  Product: [
    { label: "Browse Instruments", href: "/instruments" },
    { label: "Book Now", href: "/booking" },
    { label: "Pricing", href: "/instruments" },
  ],
  Company: [
    { label: "About Us", href: "#" },
    { label: "Contact", href: "#" },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="col-span-1">
            ...
            <p className="text-gray-500 text-sm leading-relaxed">
              Rent premium musical instruments for your next gig, event, or practice session. Quality gear, affordable prices.
            </p>
            {/* Social Icons */}
            <div className="flex gap-3 mt-5">
              {["twitter", "github", "instagram"].map((social) => (
                <a
                  key={social}
                  href="#"
                  className="w-9 h-9 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center text-gray-500 hover:text-violet-400 hover:border-violet-500/30 hover:bg-violet-500/10 transition-all duration-200"
                  aria-label={social}
                >
                  {social === "twitter" && (
        ...
        <div className="mt-12 pt-8 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-gray-600">
            © {new Date().getFullYear()} MusicRent. All rights reserved.
          </p>
